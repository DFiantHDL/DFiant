  ...
  object Token {
    ...
    def stringInterpolatorGen(k : String)(c: whitebox.Context) : c.Tree = {
      ...
      val buildTree = k match {
        case "b" => q"dfhdl.Bits.Token.fromBinString($fullExpressionTree).toOption.get"
        case "h" => q"dfhdl.Bits.Token.fromHexString($fullExpressionTree).toOption.get"
      }
      q"""
         new dfhdl.Interpolator[dfhdl.Bits.Token, $kTpe] {
           type Out = dfhdl.Bits.TokenW[$widthTpe]
           val value : dfhdl.Bits.TokenW[$widthTpe] = $buildTree.asInstanceOf[dfhdl.Bits.TokenW[$widthTpe]]
         }
       """
    }
...
//      }
  ...
  ///////////////////////////////////////////////////////////////////////////////////////////////////////////////
  protected[dfhdl] sealed class SameBitsVector(val value : Boolean)
