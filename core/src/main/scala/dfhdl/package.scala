...
package object dfhdl {
  ...
  /**
    ...
    *                       //and checked during DFHDL compilation
    * }}}
    */
  ...
  implicit class BackendExt[D <: DFDesign, T](t : T)(
    ...
    /**
      ...
      *
      * The dataflow DFHDL design can be compiled into various backends that are available under [[compiler.backend]].
...
//  protected[dfhdl] type <~>[DF <: DFAny, Dir <: DFDir] = DFAny.Port[DF#TType, Dir]
  ...
  protected[dfhdl] trait DEFAULT_DIR {
    private[dfhdl] var currentDefault : DclDir = VAR
  ...
  ////////////////////////////////////////////////////////////////////////////////////
  // Exception handling for DFHDL code errors
  ////////////////////////////////////////////////////////////////////////////////////
  def errordf(msg : String)(implicit ctx : DFMember.Context) : Nothing = {
    ...
    println(s"${RED}DFHDL compilation failed at:\n$pos\nin:\n$fullName\nwith:\n$msg$RESET")
    sys.exit(1)
  }
  ...
  // Collection Operations
  ////////////////////////////////////////////////////////////////////////////////////
  protected[dfhdl] final case class OutsideOwner(op : DFDesign.Control.Op.Entry) extends DFMember.CustomTagOf[DFMember]
