...
import dfhdl.FSM.Step
import dfhdl.internals.{GroupByOrderedImplicitImpl, IntExtras, IterableStringsOps, Meta}
...
sealed abstract class FSM(implicit protected[FSM] val ctx : DFBlock.Context) {
  ...
  protected[dfhdl] def getStepMap : ListMap[Step, Option[Step]]
...
object FSM {
  trait Capable
  protected[dfhdl] final class Step private[FSM] (val alwaysBlock : () => Unit, val exitBlock : () => Unit = () => {})(
    implicit ctx : DFBlock.Context
  ) extends FSM {
    protected[dfhdl] lazy val getStepMap : ListMap[Step, Option[Step]] = ListMap(this -> None)
  ...
  protected[FSM] final class StepChain private[FSM] (stepMap : ListMap[Step, Option[Step]], nextFSM : () => FSM)(
    ...
    protected[dfhdl] lazy val getStepMap : ListMap[Step, Option[Step]] = {
  ...
  object HasFSMAscription {
    ...
    def evMacro(c: blackbox.Context) : c.Tree = {
      ...
      q"new dfhdl.FSM.HasFSMAscription{}"
    }
  }
  ///////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  protected[dfhdl] def elaboration(mutableDB : DFDesign.DB.Mutable, fsmTrack : List[FSM]) : Unit = {
